...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Fighter.fightswon'
        db.add_column(u'whowin_fighter', 'fightswon',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Fighter.fightslost'
        db.add_column(u'whowin_fighter', 'fightslost',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Fighter.fightswon'
        db.delete_column(u'whowin_fighter', 'fightswon')

        # Deleting field 'Fighter.fightslost'
        db.delete_column(u'whowin_fighter', 'fightslost')
