...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Fight.user'
        db.add_column(u'whowin_fight', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Fight.winner'
        db.add_column(u'whowin_fight', 'winner',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='winner', null=True, to=orm['whowin.Fighter']),
                      keep_default=False)
        ...
        # Adding field 'Fight.loser'
        db.add_column(u'whowin_fight', 'loser',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='loser', null=True, to=orm['whowin.Fighter']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Fight.user'
        db.delete_column(u'whowin_fight', 'user_id')

        # Deleting field 'Fight.winner'
        db.delete_column(u'whowin_fight', 'winner_id')
        ...
        # Deleting field 'Fight.loser'
        db.delete_column(u'whowin_fight', 'loser_id')
    ...
    models = {
        ...
        u'whowin.fight': {
            ...
            'loser_end_rating': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '2', 'blank': 'True'}),
            'loser_endnd_rank': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'loser_start_rank': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'loser_start_rating': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '2', 'blank': 'True'}),
            ...
            'winner_end_rank': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'winner_end_rating': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '2', 'blank': 'True'}),
            'winner_start_rank': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'winner_start_rating': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '2', 'blank': 'True'})
        },
        u'whowin.fighter': {
